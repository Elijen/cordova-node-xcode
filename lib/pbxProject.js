...
pbxProject.prototype.addToHeaderSearchPaths = function(file) {
    ...
    for (config in configurations) {
        //let targetName = buildSettings["TARGET_NAME"]
        buildSettings = configurations[config].buildSettings;
        ...
        if (typeof buildSettings['HEADER_SEARCH_PATHS'] === 'string') {
          buildSettings['HEADER_SEARCH_PATHS'] = [buildSettings['HEADER_SEARCH_PATHS']]
        }
